...
while(pages>0):
    try:
        ...
        button_next = wd_Chrome.find_element(By.CSS_SELECTOR, '#lista_next')
        wd_Chrome.execute_script("arguments[0].click();", button_next)
        time.sleep(1)
...
filename = "dataset_contratos_2023.csv"
df.to_csv(filename, sep=";")

# Para o próximo, fazer com contratos do segundo semestre de 2023.